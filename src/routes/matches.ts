...
import {createMatchSchema, listMatchesQuerySchema, MATCH_STATUS, matchIdParamSchema, updateScoreSchema} from "../validation/matches.js";
...
matchRouter.patch('/:id/score', async (req, res) => {
    ...
    try {
        ...
        await syncMatchStatus(existing, async (nextStatus: any) => {
            await db
                .update(matches)
